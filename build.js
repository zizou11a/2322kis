...
// تاريخ اليوم بصيغة YYYY-MM-DD (يُستخدم كـ lastmod لصفحات الأدوات المُولّدة)
const TODAY = new Date().toISOString().slice(0, 10);

// الصفحات الثابتة (غير المُولّدة من tools-data.js)
// كل صفحة هنا تُكتب كما هي مع lastmod الخاص بها — عدّل التاريخ يدوياً عند تحديث الصفحة
const STATIC_PAGES = [
  { loc: "/",                                                 lastmod: "2026-06-04" },
  { loc: "/image-converter/",                                 lastmod: "2026-06-04" },
  { loc: "/watermark-image/",                                 lastmod: "2026-06-04" },
  { loc: "/view-image-metadata/",                             lastmod: "2026-06-04" },
  { loc: "/remove-exif-data/",                                lastmod: "2026-06-04" },
  { loc: "/svg-converter/",                                   lastmod: "2026-06-04" },

  // مقالات / دليل
  { loc: "/jpg-vs-png/",                                      lastmod: "2026-06-04" },
  { loc: "/png-vs-webp/",                                     lastmod: "2026-06-04" },
  { loc: "/webp-vs-avif/",                                    lastmod: "2026-06-04" },
  { loc: "/avif-vs-jpeg/",                                    lastmod: "2026-06-04" },
  { loc: "/best-image-format/",                               lastmod: "2026-06-04" },
  { loc: "/best-image-format-for-websites/",                  lastmod: "2026-06-04" },
  { loc: "/image-optimization-checklist-for-websites/",       lastmod: "2026-06-04" },
  { loc: "/alt-text-best-practices/",                         lastmod: "2026-06-04" },
  { loc: "/lazy-loading-images-guide/",                       lastmod: "2026-06-04" },
  { loc: "/lcp-image-optimization/",                          lastmod: "2026-06-04" },
  { loc: "/seo-friendly-image-names/",                        lastmod: "2026-06-04" },
  { loc: "/image-caching-guide/",                             lastmod: "2026-06-04" },
  { loc: "/ecommerce-image-optimization/",                    lastmod: "2026-06-04" },
  { loc: "/lossless-vs-lossy/",                               lastmod: "2026-06-04" },
  { loc: "/how-image-compression-works/",                     lastmod: "2026-06-04" },
  { loc: "/image-compression-guide/",                         lastmod: "2026-06-04" },
  { loc: "/reduce-image-size-without-losing-quality/",        lastmod: "2026-06-04" },
  { loc: "/responsive-images-guide/",                         lastmod: "2026-06-04" },
  { loc: "/image-cdn-optimization/",                          lastmod: "2026-06-04" },
  { loc: "/image-seo-checklist/",                             lastmod: "2026-06-04" },
  { loc: "/image-sitemap-guide/",                             lastmod: "2026-06-04" },
  { loc: "/image-optimization-tools/",                        lastmod: "2026-06-04" },
  { loc: "/browser-image-support/",                           lastmod: "2026-06-04" },
  { loc: "/how-to-convert-jpg-to-png-online/",                lastmod: "2026-06-04" },
  { loc: "/how-to-optimize-images-for-core-web-vitals/",      lastmod: "2026-06-04" },
  { loc: "/how-to-optimize-images-for-google-pagespeed/",     lastmod: "2026-06-04" },
  { loc: "/how-to-remove-exif-metadata/",                     lastmod: "2026-06-04" },
  { loc: "/best-free-image-converter-online/",                lastmod: "2026-06-04" },
  { loc: "/heic-to-jpg/",                                     lastmod: "2026-06-04" },
  { loc: "/heic-vs-jpg/",                                     lastmod: "2026-06-04" },
  ...
  { loc: "/authors/",                                         lastmod: "2026-06-04" },
  { loc: "/contact/",                                         lastmod: "2026-06-04" },
  { loc: "/privacy-policy/",                                  lastmod: "2026-06-04" },
  { loc: "/terms-of-use/",                                    lastmod: "2026-06-04" },
  { loc: "/editorial-policy/",                                lastmod: "2026-06-04" },

  // النسخ العربية
  { loc: "/ar/",                                              lastmod: "2026-06-04" },
  { loc: "/ar/compress-image/",                               lastmod: "2026-06-04" },
  { loc: "/ar/jpg-to-png/",                                   lastmod: "2026-06-04" },
  { loc: "/ar/jpg-to-webp/",                                  lastmod: "2026-06-04" },
  { loc: "/ar/png-to-jpg/",                                   lastmod: "2026-06-04" },
  { loc: "/ar/png-to-webp/",                                  lastmod: "2026-06-04" },
  { loc: "/ar/resize-image/",                                 lastmod: "2026-06-04" },

  // النسخ الإسبانية والفرنسية
  { loc: "/es/",                                              lastmod: "2026-06-04" },
  { loc: "/fr/",                                              lastmod: "2026-06-04" },
];

// توليد sitemap.xml كاملاً: الصفحات الثابتة + صفحات الأدوات (lastmod = اليوم)
function buildSitemap(tools) {
  const staticUrls = STATIC_PAGES.map(p =>
    `  <url><loc>${BASE_URL}${p.loc}</loc><lastmod>${p.lastmod}</lastmod></url>`
  ).join("\n");

  const toolUrls = tools.map(t =>
    `  <url><loc>${BASE_URL}/${t.slug}/</loc><lastmod>${TODAY}</lastmod></url>`
  ).join("\n");
...
${staticUrls}
  ...
  <!-- صفحات الأدوات (مُولّدة تلقائياً من tools-data.js) -->
${toolUrls}
...
// ── توليد sitemap.xml ─────────────────────────────────────
const sitemapXml = buildSitemap(tools);
fs.writeFileSync(path.join(OUTPUT_DIR, "sitemap.xml"), sitemapXml, "utf8");
console.log(`🗺️   تم توليد sitemap.xml (${STATIC_PAGES.length} صفحة ثابتة + ${tools.length} صفحة أداة)`);
